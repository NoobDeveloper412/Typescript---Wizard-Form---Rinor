        ...
        <div className="cs-invoice cs-style1">
            ...
            <div className="cs-invoice_head cs-type1 cs-mb25">
              <div className="cs-invoice_left">
                <p className="cs-invoice_number cs-primary_color cs-mb0 cs-f16">
                  <b className="cs-primary_color">PNR No:</b> {"{"}PNR{"}"}
                </p>
              </div>
          ...
          <div className="cs-table cs-style1">
                  ...
                  <tbody>
                    <tr>
                      <td className="cs-width_6">
                        <b className="cs-primary_color">Airline:</b> {"{"}
                        airline{"}"}
                      </td>
                      <td className="cs-width_6">
                        <b className="cs-primary_color">Airline Code: </b>
                        {"{"}code{"}"}
                      </td>
                    </tr>
                    <tr>
                      <td className="cs-width_6">
                        <b className="cs-primary_color">PNR: </b>
                        {"{"}PNR{"}"}
                      </td>
                      <td className="cs-width_6">
                        <b className="cs-primary_color">Ticket No: </b>
                        {"{"}ticket{"}"}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="cs-width_6">
                        <b className="cs-primary_color">Departure Date: </b>
                        {"{"}journeyDate{"}"}
                      </td>
                    </tr>
                    <tr>
                      <td className="cs-width_6">
                        <b className="cs-primary_color">Issued By: </b>
                        {"{"}issuedBy{"}"}
                      </td>
                      <td className="cs-width_6">
                        <b className="cs-primary_color">Ledger: </b>
                        {"{"}Ledger{"}"}
                      </td>
                    </tr>
                  </tbody>
            ...
            <table>
              <thead>
                <tr>
                  <td className="cs-width_8 cs-primary_color cs-semi_bold">
                    Sales Commission:
                  </td>
                  <td className="cs-width_8 cs-primary_color cs-semi_bold">
                    Discount:
